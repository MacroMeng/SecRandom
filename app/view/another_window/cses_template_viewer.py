...
class CsesTemplateViewerWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # 复制到剪贴板按钮
        self.copy_button = PushButton(get_content_name_async("time_settings", "copy_to_clipboard"))
        self.copy_button.setIcon(get_theme_icon("ic_fluent_copy_20_filled"))
        self.copy_button.clicked.connect(self.on_copy_clicked)
        
        # 保存为文件按钮
        self.save_button = PushButton(get_content_name_async("time_settings", "save_as_file"))
        ...
        try:
            ...
            if file_path:
                ...
                InfoBar.success(
                    ...
                    content=get_content_name_async("time_settings", "template_saved").format(file_path),
                    orient=Qt.Horizontal,
                    isClosable=True,
                    position=InfoBarPosition.TOP,
                    duration=3000,
